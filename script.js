...
"money or profit.", "You will carry confidence, clarity, and positive influence wherever you go.", "Rid yourself of the people in your life that are holding you back," +
...
function runFunction(){
    ...
    if(happyBirthday(month, day) == true){
    ...
    document.getElementById("sign").innerHTML = ("Hello " + name + ", " + "your sign is " + signs[sign] + ".")
